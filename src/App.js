...
const mockItems = [
  { id: 'ITEM-A123', name: 'Product Alpha', defaultUomId: 'EA', defaultUnitPrice: 15.00 },
  { id: 'ITEM-B456', name: 'Product Beta', defaultUomId: 'BOX', defaultUnitPrice: 25.50 },
  { id: 'ITEM-C789', name: 'Product Gamma', defaultUomId: 'PC', defaultUnitPrice: 75.00 },
  { id: 'ITEM-D101', name: 'Product Delta', defaultUomId: 'EA', defaultUnitPrice: 12.00 },
  { id: 'ITEM-E202', name: 'Product Epsilon', defaultUomId: 'SET', defaultUnitPrice: 30.00 },
  { id: 'ITEM-F303', name: 'Product Zeta', defaultUomId: 'PC', defaultUnitPrice: 100.00 },
];
...
const SalesDistributionEntry = ({ onClose, invoiceHeaderData }) => {
  const [distributions, setDistributions] = useState([
    { id: 1, account: '000-1200-00', type: 'RECV', debit: 89198.87, credit: 0.00, description: '' },
    { id: 2, account: '000-4100-01', type: 'SALES', debit: 0.00, credit: 5645.47, description: '' },
    { id: 3, account: '000-4110-01', type: 'SALES', debit: 0.00, credit: 78079.40, description: '' },
    { id: 4, account: '000-2300-00', type: 'TAXES', debit: 0.00, credit: 4692.00, description: '' },
    { id: 5, account: '000-2310-00', type: 'TAXES', debit: 0.00, credit: 782.00, description: '' },
    { id: 6, account: '300-5130-00', type: 'COMMEXP', debit: 2511.81, credit: 0.00, description: '' },
    { id: 7, account: '000-2120-00', type: 'COMMPAY', debit: 0.00, credit: 2511.81, description: '' },
    { id: 8, account: '', type: '', debit: 0.00, credit: 0.00, description: '' }, // Empty row
    { id: 9, account: '', type: '', debit: 0.00, credit: 0.00, description: '' }, // Empty row
  ]);
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center p-4 z-50 font-sans">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl h-[90vh] max-h-full flex flex-col">
        ...
        <div className="p-4 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-x-6 md:gap-x-10 gap-y-3 md:gap-y-4 border-b border-gray-200 text-sm">
          <div className="flex flex-col space-y-3">
            <div className="flex items-center">
              ...
              <input type="text" id="dist-customer-id" defaultValue={invoiceHeaderData?.customerId || ''} readOnly className="flex-grow p-2 border border-gray-300 rounded-md bg-gray-50 text-sm" />
            </div>
            <div className="flex items-center">
              <label htmlFor="dist-customer-name" className="w-28 sm:w-36 text-gray-700 font-medium">Name</label>
              <input type="text" id="dist-customer-name" defaultValue={invoiceHeaderData?.customerName || ''} readOnly className="flex-grow p-2 border border-gray-300 rounded-md bg-gray-50 text-sm" />
            </div>
          </div>
          <div className="flex flex-col space-y-3">
            <div className="flex items-center">
              <label htmlFor="dist-document-no" className="w-28 sm:w-36 text-gray-700 font-medium">Document No.</label>
              <input type="text" id="dist-document-no" defaultValue={invoiceHeaderData?.documentNumber || ''} readOnly className="flex-grow p-2 border border-gray-300 rounded-md bg-gray-50 text-sm" />
            </div>
            <div className="flex items-center">
              <label htmlFor="dist-document-type" className="w-28 sm:w-36 text-gray-700 font-medium">Document Type</label>
              <input type="text" id="dist-document-type" defaultValue={invoiceHeaderData?.documentType || ''} readOnly className="flex-grow p-2 border border-gray-300 rounded-md bg-gray-50 text-sm" />
            </div>
            <div className="flex items-center">
              ...
              <div className="flex-grow flex items-center gap-2">
                ...
                <input type="text" id="dist-functional-amount" defaultValue="89,198.87" readOnly className="flex-grow p-2 border border-gray-300 rounded-md bg-gray-50 text-right text-sm" />
              </div>
            </div>
            <div className="flex items-center">
              ...
              <div className="flex-grow flex items-center gap-2">
                <span className="mr-1 text-gray-600 font-semibold">$</span>
                <input type="text" id="dist-originating-amount" defaultValue="0.00" readOnly className="flex-grow p-2 border border-gray-300 rounded-md bg-gray-50 text-right text-sm" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 p-4 md:p-6 overflow-y-auto">
          ...
          <div className="overflow-x-auto mb-4 border border-gray-300 rounded-lg">
            <table className="w-full border-collapse bg-white">
              <thead>
                <tr>
                  <th className="border border-gray-200 p-2 md:p-3 text-left bg-gray-100 font-semibold text-gray-700 text-xs sm:text-sm w-[15%]">Account</th>
                  <th className="border border-gray-200 p-2 md:p-3 text-left bg-gray-100 font-semibold text-gray-700 text-xs sm:text-sm w-[10%]">Type</th>
                  <th className="border border-gray-200 p-2 md:p-3 text-left bg-gray-100 font-semibold text-gray-700 text-xs sm:text-sm w-[15%]">Debit</th>
                  <th className="border border-gray-200 p-2 md:p-3 text-left bg-gray-100 font-semibold text-gray-700 text-xs sm:text-sm w-[15%]">Credit</th>
                  <th className="border border-gray-200 p-2 md:p-3 text-left bg-gray-100 font-semibold text-gray-700 text-xs sm:text-sm w-[25%]">Description</th>
                  <th className="border border-gray-200 p-2 md:p-3 text-left bg-gray-100 font-semibold text-gray-700 text-xs sm:text-sm w-[10%]">Originating Debit</th>
                  <th className="border border-gray-200 p-2 md:p-3 text-left bg-gray-100 font-semibold text-gray-700 text-xs sm:text-sm w-[10%]">Originating Credit</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr key={dist.id}>
                    <td className="border border-gray-200 p-2">
                      <input
                        type="text"
                        value={dist.account}
                        onChange={(e) => handleDistributionChange(dist.id, 'account', e.target.value)}
                    ...
                    <td className="border border-gray-200 p-2">
                      <select
                        value={dist.type}
                        onChange={(e) => handleDistributionChange(dist.id, 'type', e.target.value)}
                        className="border-none w-full p-1 text-xs sm:text-sm bg-transparent focus:outline-none focus:ring-red-700 focus:border-red-700"
                      >
                        <option>RECV</option>
                        <option>SALES</option>
                    ...
                    <td className="border border-gray-200 p-2">
                      <input
                        type="number"
                        value={dist.debit}
                        onChange={(e) => handleDistributionChange(dist.id, 'debit', parseFloat(e.target.value) || 0)}
                    ...
                    <td className="border border-gray-200 p-2">
                      <input
                        type="number"
                        value={dist.credit}
                        onChange={(e) => handleDistributionChange(dist.id, 'credit', parseFloat(e.target.value) || 0)}
                        className="border-none w-full p-1 text-xs sm:text-sm bg-transparent text-right focus:outline-none focus:ring-red-700 focus:border-red-700"
                      />
                    </td>
                    <td className="border border-gray-200 p-2">
                      <input
                        ...
                        onChange={(e) => handleDistributionChange(dist.id, 'description', e.target.value)}
                        className="border-none w-full p-1 text-xs sm:text-sm bg-transparent focus:outline-none focus:ring-red-700 focus:border-red-700"
                      />
                    </td>
                    <td className="border border-gray-200 p-2">
        ...
        <div className="p-4 bg-gray-100 border-t border-gray-200 flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-4 rounded-b-lg">
          ...
          <button className="bg-red-700 text-white rounded-md px-4 py-2 text-sm font-medium shadow-sm hover:bg-red-800 transition-colors duration-200">Delete</button>
          <button className="bg-gray-700 text-white rounded-md px-4 py-2 text-sm font-medium shadow-sm hover:bg-gray-800 transition-colors duration-200">Default</button>
        </div>
      </div>
    </div>
  );
          ...
          {addresses.length > 0 ? (
            <ul className="divide-y divide-gray-100">
              {addresses.map((address, index) => (
                <li key={index} className="p-3 hover:bg-gray-50 cursor-pointer transition-colors duration-150" onClick={() => onSelectAddress(address)}>
                  {address}
                </li>
              ))}
            </ul>
          ) : (
            <p className="p-4 text-gray-600 text-center">No addresses found for this customer.</p>
          )}
        </div>
...
const SalesTransactionEntryForm = ({ onDistributionsClick }) => {
  ...
  const [lineItems, setLineItems] = useState([
    ...
    { id: 2, itemId: 'ITEM-B456', uomId: 'BOX', qtyOrdered: 5, unitPrice: 25.50, extendedPrice: 0.00 },
    { id: 3, itemId: 'ITEM-C789', uomId: 'PC', qtyOrdered: 2, unitPrice: 75.00, extendedPrice: 0.00 },
  ]);
        ...
        <div className="main-content p-4 sm:p-6 bg-white">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 md:gap-x-10 gap-y-3 md:gap-y-4 mb-6 sm:mb-8 text-sm">
            <div className="flex flex-col space-y-3">
              ...
              <div className="flex items-center">
                <label htmlFor="type-id" className="w-28 sm:w-36 text-gray-700 font-medium">Type/Type ID :</label>
                <div className="flex-grow flex items-center gap-2">
                  <select id="type-id" value={documentType} onChange={handleDocumentTypeChange} className="flex-grow p-2 border border-gray-300 rounded-md bg-gray-50 text-sm focus:ring-red-700 focus:border-red-700">
                    <option>Order</option>
                    <option>Invoice</option>
                  </select>
                  <input type="text" defaultValue="STDORD" className="flex-grow p-2 border border-gray-300 rounded-md bg-gray-50 text-sm focus:ring-red-700 focus:border-red-700" />
                </div>
              </div>
              <div className="flex items-center">
          ...
          <div className="overflow-x-auto mb-6 sm:mb-8">
            <table className="w-full border-collapse mt-2 bg-white border border-gray-300 rounded-lg">
              <thead>
                <tr>
                  <th className="border border-gray-200 p-2 md:p-3 text-left bg-gray-100 font-semibold text-gray-700 text-xs sm:text-sm w-1/4 cursor-pointer" onClick={() => handleSort('itemId')}> {/* Changed sort column to itemId */}
                    Item Number{' '}
                    {sortColumn === 'itemId' && (
                      sortDirection === 'asc' ? '▲' : '▼'
                    )}
                  </th>
                  <th className="border border-gray-200 p-2 md:p-3 text-left bg-gray-100 font-semibold text-gray-700 text-xs sm:text-sm w-1/6 cursor-pointer" onClick={() => handleSort('uomId')}> {/* Changed sort column to uomId */}
                    U of M{' '}
                    {sortColumn === 'uomId' && (
                      sortDirection === 'asc' ? '▲' : '▼'
                    )}
              ...
              <tbody>
                ...
                {Array(Math.max(0, 3 - sortedLineItems.length)).fill('').map((_, index) => (
                  <tr key={`empty-row-${index + sortedLineItems.length}`}> {/* Unique key */}
                    ...
                    <td className="border border-gray-200 p-2"><input type="text" className="border-none w-full p-1 text-xs sm:text-sm bg-transparent focus:outline-none" defaultValue="" disabled /></td>
                    <td className="border border-gray-200 p-2"><input type="text" className="border-none w-full p-1 text-xs sm:text-sm bg-transparent focus:outline-none" defaultValue="" readOnly disabled /></td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mt-4 sm:mt-6 space-y-4 sm:space-y-0">
            ...
            <div className="flex items-center w-full sm:w-auto justify-end">
              ...
              <div className="flex items-center">
                ...
                <input type="text" value={(totalExtendedPrice + 15.00 + 25.65).toFixed(2)} className="p-2 border border-gray-300 rounded-md bg-gray-50 text-right font-bold text-lg w-28 sm:w-32" readOnly /> {/* Adjusted total calculation */}
              </div>
            </div>
          </div>
        </div>
...
const sideNavSections = {
  home: [
    { label: 'Overview', page: 'overview', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-9v10a1 1 0 001 1h3M10 2l-2 2m0 0l-7 7m7-7v7"></path></svg>
    )},
  ],
  dashboard: [
    { label: 'Analytics', page: 'analytics', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m7 0V5a2 2 0 012-2h2a2 2 0 012 2v10m-7 0h7"></path></svg>
    )},
    { label: 'Reports', page: 'reports', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
    )},
    { label: 'Data Management', page: 'data', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16V9m2 7V9m-2 7H9M6 18h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
    )},
  ],
  sales: [ // New Sales category
    { label: 'Invoice Entry', page: 'sales-transaction-entry', icon: ( // Changed label to Invoice Entry
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 10a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
    )},
  ],
  settings: [
    { label: 'General Settings', page: 'general-settings', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>
    )},
    { label: 'Security', page: 'security-settings', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.023 12.023 0 002.944 12c0 2.872 1.15 5.518 3.04 7.412a12.023 12.023 0 007.412 3.04 12.023 12.023 0 007.412-3.04C20.85 17.518 22 14.872 22 12a12.023 12.023 0 00-3.04-8.618z"></path></svg>
    )},
  ],
  profile: [
    { label: 'My Profile', page: 'my-profile', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
    )},
    { label: 'Preferences', page: 'preferences', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.182 2.572-1.065z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
    )},
  ],
};
...
const App = () => {
  ...
  const [topNavActiveItem, setTopNavActiveItem] = useState('home');
  const [showDistributionPopup, setShowDistributionPopup] = useState(false);
  const [invoiceHeaderDataForDistribution, setInvoiceHeaderDataForDistribution] = useState(null); // State to pass data to popup
  ...
  const renderContent = () => {
    switch (currentPage) {
        ...
        return (
          <>
            <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-200">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">Welcome to Your Application!</h2>
              <p className="text-sm sm:text-base text-gray-700">
                This is the Overview page. Here you'll find a general summary of your data.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-200">
                <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-800">Overview Card 1</h3>
                <p className="text-sm sm:text-base text-gray-700">Display key metrics or important information here.</p>
              </div>
              <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-200">
                <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-800">Overview Card 2</h3>
                <p className="text-sm sm:text-base text-gray-700">Summarize recent activity or progress.</p>
              </div>
              <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-200">
                <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-800">Overview Card 3</h3>
                <p className="text-sm sm:text-base text-gray-700">Provide quick links or actions related to your app.</p>
              </div>
            </div>
          </>
        );
      case 'analytics':
        return (
          <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-200">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">Analytics Dashboard</h2>
            <p className="text-sm sm:text-base text-gray-700">
              This section is dedicated to detailed analytics and reports.
            </p>
            <p className="text-xs sm:text-sm text-gray-600 mt-3 sm:mt-4">
              Imagine charts, graphs, and data tables here!
            </p>
            <div className="mt-4 sm:mt-6 h-48 sm:h-64 bg-gray-100 rounded-lg flex items-center justify-center text-gray-500 border border-gray-200">
      ...
      case 'reports':
        return (
          <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-200">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">Generate Reports</h2>
            <p className="text-sm sm:text-base text-gray-700">
      ...
      case 'data':
        return (
          <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-200">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">Data Management</h2>
            <p className="text-sm sm:text-base text-gray-700">
              View, add, edit, or delete your application data.
            </p>
            <div className="mt-3 sm:mt-4 flex flex-col sm:flex-row space-y-2 sm:space-y-0">
              <button className="bg-black text-white px-3 py-2 rounded-md hover:bg-gray-800 mr-0 sm:mr-2 transition-colors duration-200 shadow-sm text-sm">Add New Data</button>
              <button className="bg-gray-200 text-gray-800 px-3 py-2 rounded-md hover:bg-gray-300 transition-colors duration-200 shadow-sm text-sm">Export Data</button>
            </div>
            <div className="mt-4 sm:mt-6 border border-gray-200 rounded-lg p-3 sm:p-4">
              <h3 className="text-base sm:text-lg font-semibold mb-2 text-gray-800">Recent Data Entries</h3>
      ...
      case 'sales-transaction-entry':
        return <SalesTransactionEntryForm onDistributionsClick={openDistributionsPopup} />;
      case 'general-settings':
        return (
          <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-200">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">General Settings</h2>
            <p className="text-sm sm:text-base text-gray-700">
              Adjust general application preferences.
            </p>
            <form className="mt-3 sm:mt-4 space-y-3 sm:space-y-4">
              <div>
                <label htmlFor="language" className="block text-gray-700 font-medium mb-1 text-sm">Language</label>
                <select id="language" className="w-full p-2 border border-gray-300 rounded-md focus:ring-red-700 focus:border-red-700 text-sm">
                  <option>English</option>
                  <option>Spanish</option>
                  <option>French</option>
                </select>
              </div>
              <button type="submit" className="bg-black text-white px-3 py-2 rounded-md hover:bg-gray-800 transition-colors duration-200 shadow-sm text-sm">Save Changes</button>
            </form>
          </div>
        );
      case 'security-settings':
        return (
          <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-200">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">Security Settings</h2>
            <p className="text-sm sm:text-base text-gray-700">
              Manage your account's security options.
            </p>
            <ul className="mt-3 sm:mt-4 space-y-2 text-sm">
              <li className="flex items-center">
                <input type="checkbox" id="twoFactor" className="mr-2 accent-red-700" />
                <label htmlFor="twoFactor">Enable Two-Factor Authentication</label>
              </li>
              <li className="flex items-center">
                <button className="text-red-700 hover:underline focus:outline-none">Change Password</button>
              </li>
            </ul>
          </div>
        );
      case 'my-profile':
        return (
          <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-200">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">My Profile</h2>
            <p className="text-sm sm:text-base text-gray-700">
            ...
            <button className="mt-4 sm:mt-6 bg-black text-white px-3 py-2 rounded-md hover:bg-gray-800 transition-colors duration-200 shadow-sm text-sm">Edit Profile</button>
          </div>
        );
      case 'preferences':
        return (
          <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-200">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">User Preferences</h2>
            <p className="text-sm sm:text-base text-gray-700">
              Customize your application experience.
            </p>
            <form className="mt-3 sm:mt-4 space-y-3 sm:space-y-4">
              <div>
                <label htmlFor="notifications" className="block text-gray-700 font-medium mb-1 text-sm">Notifications</label>
                <input type="checkbox" id="notifications" className="mr-2 accent-red-700" defaultChecked /> Enable email notifications
              </div>
              <div>
                <label htmlFor="timezone" className="block text-gray-700 font-medium mb-1 text-sm">Timezone</label>
                <select id="timezone" className="w-full p-2 border border-gray-300 rounded-md focus:ring-red-700 focus:border-red-700 text-sm">
                  <option>UTC-5:00 Central Time (US & Canada)</option>
                  <option>UTC-8:00 Pacific Time (US & Canada)</option>
                </select>
              </div>
              <button type="submit" className="bg-black text-white px-3 py-2 rounded-md hover:bg-gray-800 transition-colors duration-200 shadow-sm text-sm">Save Preferences</button>
            </form>
          </div>
        );
      default:
        return (
          <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-200">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">Page Not Found</h2>
            <p className="text-sm sm:text-base text-gray-700">
    ...
    <div className="min-h-screen bg-gray-100 font-sans text-gray-800 flex flex-col">
      ...
      <div className="bg-black p-3 sm:p-4 flex items-center justify-between border-b border-gray-800 shadow-sm">
        <div className="flex items-center space-x-1 sm:space-x-2">
          {/* Verizon Logo */}
          <span className="text-red-700 text-2xl sm:text-3xl font-bold">verizon</span>
          <span className="text-sm sm:text-lg font-semibold text-white hidden sm:block">| OEM Portal</span>
        </div>
        <div className="flex items-center space-x-2 sm:space-x-4 text-white text-xs sm:text-sm">
            ...
            <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10v11h18V10M3 10a2 2 0 012-2h14a2 2 0 012 2M3 10v1a2 2 0 002 2h14a2 2 0 002-2v-1"></path></svg>
      ...
      <header className="bg-white text-gray-900 p-3 sm:p-4 flex items-center justify-start border-b border-gray-200 overflow-x-auto whitespace-nowrap">
        <nav className="flex space-x-3 sm:space-x-6 px-2 sm:px-4">
          <button
            onClick={() => handleTopNavClick('home', 'overview')}
            className={`py-2 px-3 rounded-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none font-bold text-sm ${
              topNavActiveItem === 'home' ? 'text-red-700 border-b-2 border-red-700' : 'text-gray-700'
            }`}
          >
            Home
          </button>
          <button
            onClick={() => handleTopNavClick('dashboard', 'analytics')}
            className={`py-2 px-3 rounded-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none font-bold text-sm ${
              topNavActiveItem === 'dashboard' ? 'text-red-700 border-b-2 border-red-700' : 'text-gray-700'
            }`}
          >
            Dashboard
          </button>
          <button
            onClick={() => handleTopNavClick('sales', 'sales-transaction-entry')}
            className={`py-2 px-3 rounded-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none font-bold text-sm ${
              topNavActiveItem === 'sales' ? 'text-red-700 border-b-2 border-red-700' : 'text-gray-700'
            }`}
          >
            Sales
          </button>
          <button
            onClick={() => handleTopNavClick('settings', 'general-settings')}
            className={`py-2 px-3 rounded-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none font-bold text-sm ${
              topNavActiveItem === 'settings' ? 'text-red-700 border-b-2 border-red-700' : 'text-gray-700'
            }`}
          >
            Settings
          </button>
          <button
            ...
            className={`py-2 px-3 rounded-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none font-bold text-sm ${
              topNavActiveItem === 'profile' ? 'text-red-700 border-b-2 border-red-700' : 'text-gray-700'
            }`}
          >
            Profile
          </button>
      ...
      <footer className="bg-gray-900 text-white p-3 sm:p-4 text-center text-xs sm:text-sm border-t border-gray-700 mt-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center space-y-1 sm:space-y-0 sm:space-x-4 mt-2">
          ...
          <a href="#" className="hover:underline text-gray-300">Verizon Business</a>
        </div>
      </footer>

      {/* Render the SalesDistributionEntry popup if showDistributionPopup is true */}
      {showDistributionPopup && <SalesDistributionEntry onClose={closeDistributionsPopup} invoiceHeaderData={invoiceHeaderDataForDistribution} />}
    </div>
  );
};
